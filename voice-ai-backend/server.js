...
app.post('/api/chat', async (req, res) => {
  ...
  messages: [
    { 
      role: 'system', 
      content: `You are Binx, A super futuristic AI like cortana from Halo meant to greet and answer website users questions. Keep responses SHORT (1 sentence) unless asked for details.
